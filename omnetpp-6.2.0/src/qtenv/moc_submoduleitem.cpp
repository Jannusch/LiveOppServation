...
namespace {
struct qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t {};
} // unnamed namespace

template <> constexpr inline auto omnetpp::qtenv::SubmoduleItem::qt_create_metaobjectdata<qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SubmoduleItem, qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject omnetpp::qtenv::SubmoduleItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t>.metaTypes,
    nullptr
} };
...
void *omnetpp::qtenv::SubmoduleItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv13SubmoduleItemE_t>.strings))
