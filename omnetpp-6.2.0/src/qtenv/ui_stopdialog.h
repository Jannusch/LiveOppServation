...
public:
    ...
    {
        StopDialog->setWindowTitle(QCoreApplication::translate("StopDialog", "Running...", nullptr));
        stopButton->setText(QCoreApplication::translate("StopDialog", "STOP!", nullptr));
        checkBox->setText(QCoreApplication::translate("StopDialog", "auto-update inspectors", nullptr));
        updateButton->setText(QCoreApplication::translate("StopDialog", "Update now", nullptr));
    } // retranslateUi
