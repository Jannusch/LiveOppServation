...
namespace {
struct qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t {};
} // unnamed namespace

template <> constexpr inline auto omnetpp::qtenv::TimeLineInspector::qt_create_metaobjectdata<qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QVector<cObject*>, QPoint)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 }, { QMetaType::QPoint, 7 },
        }}),
        // Slot 'setObjectToObjectInspector'
        QtMocHelpers::SlotData<void(cObject *)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Slot 'openInspector'
        QtMocHelpers::SlotData<void(cObject *)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<TimeLineInspector, qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::TimeLineInspector::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t>.metaTypes,
    nullptr
} };
...
void *omnetpp::qtenv::TimeLineInspector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv17TimeLineInspectorE_t>.strings))
