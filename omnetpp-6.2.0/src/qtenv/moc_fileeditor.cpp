...
namespace {
struct qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t {};
} // unnamed namespace

template <> constexpr inline auto omnetpp::qtenv::FileEditor::qt_create_metaobjectdata<qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FileEditor, qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject omnetpp::qtenv::FileEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t>.metaTypes,
    nullptr
} };
...
void *omnetpp::qtenv::FileEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv10FileEditorE_t>.strings))
