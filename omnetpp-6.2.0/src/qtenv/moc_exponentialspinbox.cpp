...
namespace {
struct qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t {};
} // unnamed namespace

template <> constexpr inline auto omnetpp::qtenv::ExponentialSpinBox::qt_create_metaobjectdata<qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'adjust'
        QtMocHelpers::SlotData<void(double)>(1, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::Double, 3 },
        }}),
        // Slot 'stepBy'
    ...
    return QtMocHelpers::metaObjectData<ExponentialSpinBox, qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject omnetpp::qtenv::ExponentialSpinBox::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t>.metaTypes,
    nullptr
} };
...
void *omnetpp::qtenv::ExponentialSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7omnetpp5qtenv18ExponentialSpinBoxE_t>.strings))
