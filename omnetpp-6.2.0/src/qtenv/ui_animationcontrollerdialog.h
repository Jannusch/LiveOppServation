...
public:
    ...
    void setupUi(QDialog *AnimationControllerDialog)
    {
        if (AnimationControllerDialog->objectName().isEmpty())
            AnimationControllerDialog->setObjectName("AnimationControllerDialog");
        ...
        minSpeedSpinBox->setObjectName("minSpeedSpinBox");
        ...
        minSpeedLabel->setObjectName("minSpeedLabel");
        ...
        maxSpeedSpinBox->setObjectName("maxSpeedSpinBox");
        ...
        readingsGroupBox->setObjectName("readingsGroupBox");
        gridLayout = new QGridLayout(readingsGroupBox);
        gridLayout->setObjectName("gridLayout");
        refreshDisplayCountValueLabel = new QLabel(readingsGroupBox);
        refreshDisplayCountValueLabel->setObjectName("refreshDisplayCountValueLabel");
        ...
        animationTimeValueLabel->setObjectName("animationTimeValueLabel");
        ...
        animationSpeedValueLabel->setObjectName("animationSpeedValueLabel");
        ...
        refreshDisplayCountLabel->setObjectName("refreshDisplayCountLabel");
        ...
        currentFpsValueLabel->setObjectName("currentFpsValueLabel");
        ...
        simulationSpeedValueLabel->setObjectName("simulationSpeedValueLabel");
        ...
        bottomVerticalSpacer = new QSpacerItem(0, 0, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
    ...
    {
        AnimationControllerDialog->setWindowTitle(QCoreApplication::translate("AnimationControllerDialog", "Animation Parameters", nullptr));
        controlGroupBox->setTitle(QCoreApplication::translate("AnimationControllerDialog", "Control", nullptr));
#if QT_CONFIG(tooltip)
        minSpeedSpinBox->setToolTip(QCoreApplication::translate("AnimationControllerDialog", "Enforce minimum animation speed: overrides speed requested by the model.", nullptr));
#endif // QT_CONFIG(tooltip)
        minSpeedSpinBox->setSpecialValueText(QCoreApplication::translate("AnimationControllerDialog", "none", nullptr));
        minSpeedLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Min animation speed:", nullptr));
        playbackSpeedLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Playback speed:", nullptr));
        maxSpeedLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Max animation speed:", nullptr));
#if QT_CONFIG(tooltip)
        playbackSpeedSpinBox->setToolTip(QCoreApplication::translate("AnimationControllerDialog", "Corresponds to speed slider on the toolbar.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        maxSpeedSpinBox->setToolTip(QCoreApplication::translate("AnimationControllerDialog", "Enforce maximum animation speed: overrides speed requested by the model.", nullptr));
#endif // QT_CONFIG(tooltip)
        maxSpeedSpinBox->setSpecialValueText(QCoreApplication::translate("AnimationControllerDialog", "none", nullptr));
        profileLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Profile:", nullptr));
        noteLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Note: Animation speed maps simulation time to animation time. Playback speed maps animation time to real time.", nullptr));
        readingsGroupBox->setTitle(QCoreApplication::translate("AnimationControllerDialog", "Current Readings", nullptr));
        ...
        animationSpeedLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Animation speed:", nullptr));
        simulationSpeedLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Simulation speed:", nullptr));
        refreshDisplayCountLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Num. refreshDisplay() calls:", nullptr));
        currentFpsLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Frames per sec:", nullptr));
        currentFpsValueLabel->setText(QString());
        simulationSpeedValueLabel->setText(QString());
        animationTimeLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Animation time:", nullptr));
        holdTimeLabel->setText(QCoreApplication::translate("AnimationControllerDialog", "Hold time:", nullptr));
