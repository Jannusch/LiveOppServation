...
public:
    ...
    QAction *actionSimulationInfo;
    QWidget *centralWidget;
    QVBoxLayout *verticalLayout;
    QWidget *toolBarArea;
    QHBoxLayout *topStatusRow;
    omnetpp::qtenv::ElidingLabel *nextEventLabel;
    omnetpp::qtenv::ElidingLabel *nextModuleLabel;
    omnetpp::qtenv::ElidingLabel *nextTimeLabel;
    ...
    omnetpp::qtenv::ElidingLabel *labelConfigName;
    omnetpp::qtenv::ElidingLabel *labelMessageStats;
    QMenuBar *menuBar;
    QMenu *menuFile;
    QMenu *menuSimulate;
    QMenu *menuInspect;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/logo/logo128m"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        actionQuit->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionOneStep = new QAction(MainWindow);
        actionOneStep->setObjectName("actionOneStep");
        actionOneStep->setCheckable(true);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/tools/step"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionOneStep->setIcon(icon1);
        actionOneStep->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionRun = new QAction(MainWindow);
        actionRun->setObjectName("actionRun");
        actionRun->setCheckable(true);
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/tools/run"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRun->setIcon(icon2);
        actionRun->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionSetUpConfiguration = new QAction(MainWindow);
        actionSetUpConfiguration->setObjectName("actionSetUpConfiguration");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/tools/newrun"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSetUpConfiguration->setIcon(icon3);
        actionStop = new QAction(MainWindow);
        actionStop->setObjectName("actionStop");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/tools/stop"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionStop->setIcon(icon4);
        actionStop->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionFastRun = new QAction(MainWindow);
        actionFastRun->setObjectName("actionFastRun");
        actionFastRun->setCheckable(true);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/tools/fast"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionFastRun->setIcon(icon5);
        actionFastRun->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionExpressRun = new QAction(MainWindow);
        actionExpressRun->setObjectName("actionExpressRun");
        actionExpressRun->setCheckable(true);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/tools/express"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionExpressRun->setIcon(icon6);
        actionExpressRun->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionRunUntil = new QAction(MainWindow);
        actionRunUntil->setObjectName("actionRunUntil");
        actionRunUntil->setCheckable(true);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/tools/until"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRunUntil->setIcon(icon7);
        actionRunUntil->setShortcutContext(Qt::ShortcutContext::ApplicationShortcut);
        actionLoadNedFile = new QAction(MainWindow);
        actionLoadNedFile->setObjectName("actionLoadNedFile");
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/tools/loadned"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionLoadNedFile->setIcon(icon8);
        actionConcludeSimulation = new QAction(MainWindow);
        actionConcludeSimulation->setObjectName("actionConcludeSimulation");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/tools/finish"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionConcludeSimulation->setIcon(icon9);
        actionEventlogRecording = new QAction(MainWindow);
        actionEventlogRecording->setObjectName("actionEventlogRecording");
        actionEventlogRecording->setCheckable(true);
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/tools/recordeventlog"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionEventlogRecording->setIcon(icon10);
        actionFindInspectObjects = new QAction(MainWindow);
        actionFindInspectObjects->setObjectName("actionFindInspectObjects");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/tools/findobj"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionFindInspectObjects->setIcon(icon11);
        actionVerticalLayout = new QAction(MainWindow);
        actionVerticalLayout->setObjectName("actionVerticalLayout");
        actionVerticalLayout->setCheckable(true);
        actionVerticalLayout->setChecked(false);
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/tools/vertical"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionVerticalLayout->setIcon(icon12);
        actionHorizontalLayout = new QAction(MainWindow);
        actionHorizontalLayout->setObjectName("actionHorizontalLayout");
        actionHorizontalLayout->setCheckable(true);
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/tools/horizontal"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionHorizontalLayout->setIcon(icon13);
        actionTimeline = new QAction(MainWindow);
        actionTimeline->setObjectName("actionTimeline");
        actionTimeline->setCheckable(true);
        actionTimeline->setChecked(false);
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/tools/fes"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionTimeline->setIcon(icon14);
        actionPreferences = new QAction(MainWindow);
        actionPreferences->setObjectName("actionPreferences");
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/tools/config"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionPreferences->setIcon(icon15);
        actionSetUpUnconfiguredNetwork = new QAction(MainWindow);
        actionSetUpUnconfiguredNetwork->setObjectName("actionSetUpUnconfiguredNetwork");
        actionOpenPrimaryIniFile = new QAction(MainWindow);
        actionOpenPrimaryIniFile->setObjectName("actionOpenPrimaryIniFile");
        actionCreate_Snapshot = new QAction(MainWindow);
        actionCreate_Snapshot->setObjectName("actionCreate_Snapshot");
        actionDebugNextEvent = new QAction(MainWindow);
        actionDebugNextEvent->setObjectName("actionDebugNextEvent");
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/tools/debugnextevent"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDebugNextEvent->setIcon(icon16);
        actionRebuildNetwork = new QAction(MainWindow);
        actionRebuildNetwork->setObjectName("actionRebuildNetwork");
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/tools/rebuild"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        actionScheduledEvents->setObjectName("actionScheduledEvents");
        ...
        actionNedComponentTypes->setObjectName("actionNedComponentTypes");
        actionRegisteredClasses = new QAction(MainWindow);
        actionRegisteredClasses->setObjectName("actionRegisteredClasses");
        actionNED_Functions = new QAction(MainWindow);
        actionNED_Functions->setObjectName("actionNED_Functions");
        actionRegistered_Enums = new QAction(MainWindow);
        actionRegistered_Enums->setObjectName("actionRegistered_Enums");
        actionSupportedConfigurationOption = new QAction(MainWindow);
        actionSupportedConfigurationOption->setObjectName("actionSupportedConfigurationOption");
        actionInspectByPointer = new QAction(MainWindow);
        actionInspectByPointer->setObjectName("actionInspectByPointer");
        actionStatusDetails = new QAction(MainWindow);
        actionStatusDetails->setObjectName("actionStatusDetails");
        actionStatusDetails->setCheckable(true);
        actionFlipWindowLayout = new QAction(MainWindow);
        actionFlipWindowLayout->setObjectName("actionFlipWindowLayout");
        actionAbout_OMNeT_Qtenv = new QAction(MainWindow);
        actionAbout_OMNeT_Qtenv->setObjectName("actionAbout_OMNeT_Qtenv");
        actionRecordVideo = new QAction(MainWindow);
        actionRecordVideo->setObjectName("actionRecordVideo");
        actionRecordVideo->setCheckable(true);
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/tools/recordvideo"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionRecordVideo->setIcon(icon18);
        actionShowAnimationParams = new QAction(MainWindow);
        actionShowAnimationParams->setObjectName("actionShowAnimationParams");
        actionShowAnimationParams->setCheckable(true);
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/tools/props"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionShowAnimationParams->setIcon(icon19);
        actionDebugOnErrors = new QAction(MainWindow);
        actionDebugOnErrors->setObjectName("actionDebugOnErrors");
        actionDebugOnErrors->setCheckable(true);
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/tools/debugger"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDebugOnErrors->setIcon(icon20);
        actionClassDescriptors = new QAction(MainWindow);
        actionClassDescriptors->setObjectName("actionClassDescriptors");
        actionResultFilters = new QAction(MainWindow);
        actionResultFilters->setObjectName("actionResultFilters");
        actionResultRecorders = new QAction(MainWindow);
        actionResultRecorders->setObjectName("actionResultRecorders");
        actionMessagePrinters = new QAction(MainWindow);
        actionMessagePrinters->setObjectName("actionMessagePrinters");
        actionDebugNow = new QAction(MainWindow);
        actionDebugNow->setObjectName("actionDebugNow");
        actionSimulationInfo = new QAction(MainWindow);
        actionSimulationInfo->setObjectName("actionSimulationInfo");
        ...
        topStatusRow->setObjectName("topStatusRow");
        nextEventLabel = new omnetpp::qtenv::ElidingLabel(centralWidget);
        nextEventLabel->setObjectName("nextEventLabel");
        ...
        nextModuleLabel = new omnetpp::qtenv::ElidingLabel(centralWidget);
        nextModuleLabel->setObjectName("nextModuleLabel");
        ...
        nextTimeLabel = new omnetpp::qtenv::ElidingLabel(centralWidget);
        nextTimeLabel->setObjectName("nextTimeLabel");
        ...
        objectInspector->setObjectName("objectInspector");
        sizePolicy1.setHeightForWidth(objectInspector->sizePolicy().hasHeightForWidth());
        objectInspector->setSizePolicy(sizePolicy1);
        ...
        logInspector->setObjectName("logInspector");
        sizePolicy1.setHeightForWidth(logInspector->sizePolicy().hasHeightForWidth());
        logInspector->setSizePolicy(sizePolicy1);
        ...
        labelConfigName = new omnetpp::qtenv::ElidingLabel(centralWidget);
        labelConfigName->setObjectName("labelConfigName");
        ...
        labelMessageStats = new omnetpp::qtenv::ElidingLabel(centralWidget);
        labelMessageStats->setObjectName("labelMessageStats");
        ...
        mainToolBar->setContextMenuPolicy(Qt::ContextMenuPolicy::NoContextMenu);
        mainToolBar->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        mainToolBar->setMovable(false);
        mainToolBar->setAllowedAreas(Qt::ToolBarArea::TopToolBarArea);
        ...
        menuInspect->addSeparator();
        menuInspect->addAction(actionSimulationInfo);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#if QT_CONFIG(tooltip)
        actionTimeline->setToolTip(QCoreApplication::translate("MainWindow", "Show/hide timeline (Ctrl+Shift+T)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        actionTimeline->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+Shift+T", nullptr));
#endif // QT_CONFIG(shortcut)
        ...
        actionDebugNextEvent->setText(QCoreApplication::translate("MainWindow", "&Debug Next Step", nullptr));
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        actionRecordVideo->setToolTip(QCoreApplication::translate("MainWindow", "Record Video (Ctrl+Shift+M)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        actionRecordVideo->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+Shift+M", nullptr));
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
        actionDebugNow->setText(QCoreApplication::translate("MainWindow", "Break into Debugger", nullptr));
        actionSimulationInfo->setText(QCoreApplication::translate("MainWindow", "&Show Simulation Info", nullptr));
#if QT_CONFIG(tooltip)
        actionSimulationInfo->setToolTip(QCoreApplication::translate("MainWindow", "Show information about the current simulation", nullptr));
#endif // QT_CONFIG(tooltip)
